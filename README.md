...
1. ​Data Ingestion: The raw CSV file was loaded into a data processing environment (e.g., a Pandas DataFrame in Python).
2. ​Data Cleaning: ​Handling Missing Values: We checked for and addressed any missing data points.
​Removing Duplicates: Duplicate records were identified and removed to ensure data integrity.
​3. Data Type Conversion: Columns were converted to their correct data types (e.g., age from float to integer, if necessary).
...
5. ​Normalization: The data was normalized into a relational structure by creating separate tables (simulated in the processed CSV) for users and interactions to reduce redundancy.
